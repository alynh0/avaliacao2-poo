...
public class Cliente implements Serializable{
    ...
    public void adicionarConta(ContaInterface c) {
    ...
    public void removerConta(ContaInterface c) {
    ...
    public ContaInterface localizarContaNumero(int numero) {

		for (int i = 0; i < contas.size(); i++) {
			ContaInterface c = contas.get(i);
